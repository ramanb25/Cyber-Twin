...
<html>
  <head>
    ...
    <script type="text/javascript">
      ...
      var GMIMainShaft_Regular_Endtime = <?php echo json_encode($GMIMainShaft_Regular_Endtime); ?>;
...
function drawChart() {
        ...
        data.addColumn('number', 'Cycle Time of GMI Main Shaft (min)');
       for(var i=0; i<GMIMainShaft_Regular.length;i++){
        data.addRows([
          [GMIMainShaft_Regular_Endtime[i], GMIMainShaft_Regular[i]]
