<?php
   ...
   $db  = new mysqli(DB_SERVER, DB_USERNAME, DB_PASSWORD);
    $db->query("CREATE DATABASE if not exists ".DB_DATABASE."");
  //  $db  = new mysqli(DB_SERVER, DB_USERNAME, DB_PASSWORD,DB_DATABASE);
    ///$db = new SQLite3("events.db");
    /*** Create table for machine failure event ***/
    $db->query("use DATABASE ".DB_DATABASE."");
  ...
  `type_login` int(45) NOT NULL
    ...
    $db->query("INSERT INTO `buttons` (`id`, `name`, `under`, `show_name`) VALUES
...
(8, 'operator_unavailability', NULL, 'Operator Unavailability');");
 ...
 $db->query("INSERT INTO `cyber1`.`login` (`id_login`, `name_login`, `username`, `password`, `type_login`) VALUES (NULL, 'raman', 'raman', 'raman', '0'), (NULL, 'raman', 'ramanm', 'raman', '1');");
